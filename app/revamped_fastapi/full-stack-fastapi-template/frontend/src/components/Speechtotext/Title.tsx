...
function Title({ setMessages }: Props): React.JSX.Element {
  ...
  const resetConversation = async () => {
    ...
    await axios
      ...
      .catch((error) => {
        ...
        // we'll proceed, but let's throw it
        // reportError({ message })
        throw new Error(` ERROR - src/components/Speechtotext/Title.tsx - The errro message is : [${message}]`)
      });
